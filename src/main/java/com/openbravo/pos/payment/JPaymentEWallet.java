 ...
 */
@Slf4j
public class JPaymentEWallet extends javax.swing.JPanel implements JPaymentInterface {
   ...
   * @param sVoucher
   */
  public JPaymentEWallet(AppView app, JPaymentNotifier notifier, String sVoucher) {
